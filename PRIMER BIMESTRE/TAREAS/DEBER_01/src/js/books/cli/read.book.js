...
exports.showABookByISBN = exports.askToGetAllTheBooks = void 0;
...
const askToGetAllTheBooks = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield book_controller_1.default.getAllBooks(library.id);
});
exports.askToGetAllTheBooks = askToGetAllTheBooks;
const showABookByISBN = () => __awaiter(void 0, void 0, void 0, function* () {
    const libraries = yield library_controller_1.default.getAllLibraries();
    const selection = yield inquirer_1.default.prompt((0, update_library_1.getQuestionsForSelectLibrary)(libraries));
    const library = (0, update_library_1.getLibraryByFormat)(libraries, selection.library);
});
exports.showABookByISBN = showABookByISBN;
