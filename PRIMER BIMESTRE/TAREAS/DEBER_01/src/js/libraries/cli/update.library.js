...
exports.getLibraryByFormat = exports.getQuestionsForSelectLibrary = exports.setFormat = void 0;
...
const getQuestionsForSelectLibrary = (libraries) => {
    const formatLibraries = libraries.map(library => (0, exports.setFormat)(library));
    return [
        {
            type: 'list',
            name: 'library',
...
const getLibraryByFormat = (libraries, librarySelected) => {
    return libraries.filter(library => (0, exports.setFormat)(library) === librarySelected)[0];
};
...
const askInformationToUpdateALibrary = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    library_controller_1.default.updateLibrary(libraryModified);
});
